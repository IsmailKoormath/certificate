  ...
  <Row style={{ paddingLeft: "10px", paddingRight: "10px" }}>
    <Col sm={4}>
      ...
      >
        ...
        <div>
          <h5 style={{ paddingTop: "2px", fontSize: "15px" }}>125</h5>
          <p>Projects</p>
          <Button
            style={{
        ...
        >
          <h5 style={{ marginTop: "-18px", fontSize: "15px" }}>$1245</h5>
          <p>Revenue</p>
        </div>
      </div>
    </Col>
    <Col sm={4}>
      ...
      >
        <div className="card-body">
          <h5 className="card-title text-muted">Available Courses</h5>
    ...
    <Col sm={4}>
      ...
      >
        <div className="card-body">
          <h5 className="card-title text-muted">Course Completed Students</h5>
